    ...
    const SEO = [
    	{
    		page: "home",
    		description:
    			"I am a backend developer with expertise in Java/#C. I have experience in building scalable, secure and reliable web applications using various frameworks and technologies.",
